...
def test_overlapping_booking():
    ...
    service.create_booking(room, user1, datetime(2025, 1, 1, 10, 0), datetime(2025, 1, 1, 11, 0))

    try:
        service.create_booking(room, user2, datetime(2025, 1, 1, 10, 30), datetime(2025, 1, 1, 11, 30))
